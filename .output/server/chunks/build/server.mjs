...
import { $ as $fetch$1, i as createError$1, m as klona, n as defu, o as sanitizeStatusCode, p as defuFn, q as createHooks, t as toRouteMatcher, v as createRouter$1, w as getRequestHeaders, x as parse$1, y as getRequestHeader, z as destr, A as isEqual$1, B as setCookie, C as getCookie, D as deleteCookie } from '../runtime.mjs';
...
const _routes = [
  {
    name: "about___uk",
    path: "/about",
    component: () => import('./about-BfgNsLid.mjs')
  },
  {
    name: "about___ru",
    path: "/ru/about",
  ...
  },
  {
    ...
    component: () => import('./index-63ylrBQV.mjs')
  },
  {
    name: "index___ru",
    path: "/ru",
...
const LazyIcon = defineAsyncComponent(() => import('./index-DMCPijKJ.mjs').then((r) => r["default"] || r.default || r));
...
const localeLoaders = {
  "uk": [{ key: "../locales/uk.json", load: () => import(
    './uk-DsTmrgqF.mjs'
    /* webpackChunkName: "locale_D_58_D_58_OpenServer_home_posiosite_locales_uk_json" */
  ), cache: true }],
  "ru": [{ key: "../locales/ru.json", load: () => import(
    './ru-BmS0oEUO.mjs'
    /* webpackChunkName: "locale_D_58_D_58_OpenServer_home_posiosite_locales_ru_json" */
  ), cache: true }]
};
...
const layouts = {
  default: () => import('./default-D6QpYKZF.mjs'),
  mainpage: () => import('./mainpage-CvfFtwb6.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CILTKhwN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CBIJ521U.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, useRequestEvent as e, withLeadingSlash as f, parseURL as g, hasProtocol as h, encodeParam as i, joinURL as j, encodePath as k, useLocaleHead as l, useI18n as m, nuxtLinkDefaults as n, asyncDataDefaults as o, parseQuery as p, createError as q, resolveRouteObject as r, useAppConfig as s, injectHead as t, useRouter as u, resolveUnrefHeadInput as v, withTrailingSlash as w, __nuxt_component_0 as x };
